                ...
                <List>
                    ...
                    >
                        ...
                        >
                            ...
                            {isCollapsePages ? <ExpandLessIcon /> : <ExpandMoreIcon />}
                        </ListItemButton>
                    </ListItem>
                    <Collapse in={isCollapsePages} timeout="auto" unmountOnExit>
                        {["all-customer", "credit-customer", "paid-customer","customer-wise-report"].map((text, index) => (
                            <ListItem key={text} disablePadding sx={{ display: "block" }}>
                                <ListItemButton
                ...
                <List>
                    ...
                    >
                        ...
                        >
                            ...
                            <ListItemText primary="Manage Stocks" sx={{
                                opacity: open ? 1 : 0,
                    ...
                    <Collapse in={isCollapseStock} timeout="auto" unmountOnExit>
                        {["stock-report",  "supplier-product-wise"].map((text, index) => (
                            <ListItem key={text} disablePadding sx={{ display: "block" }}>
                                <ListItemButton
                ...
                <List>
                    ...
                    >
                        ...
                        >
                            ...
                            <ListItemText primary="Billing Details" sx={{
                                opacity: open ? 1 : 0,
                ...
                <List>
                    ...
                    >
                        ...
                        >
                            ...
                            <ListItemText primary="Billing History" sx={{
                                opacity: open ? 1 : 0,
