...
import { Box, Button, Typography, Card, CardContent, Switch, IconButton } from '@mui/material';
...
const PricingCard = ({ title, price, features, buttonLabel, variant, icon, billingPeriod, handleCheckout }) => (
  <StyledCard variant={variant}>
    <CardContent>
      ...
      <ButtonStyled onClick={() => handleCheckout(billingPeriod, price)}>{buttonLabel}</ButtonStyled>
    </CardContent>
  </StyledCard>
);
...
const Pricing = () => {
 ...
 window.location.href=data.id
  ...
  return (
    ...
    >
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, color: '#ffffff', m: 11 }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', gap: 3 }}>
        ...
        <PricingCard
          ...
          features={['Lorem ipsum dolor sit amet', 'Lorem ipsum dolor sit', 'Lorem ipsum dolor sit']}
        ...
        <PricingCard
          ...
          features={['Lorem ipsum dolor sit amet', 'Lorem ipsum dolor sit', 'Lorem ipsum dolor sit', 'Lorem ipsum dolor sit']}
          buttonLabel="Get Started"
          icon={<StarIcon />}
          billingPeriod={isAnnual ? 'annual' : 'monthly'}
          handleCheckout={handleCheckout}
